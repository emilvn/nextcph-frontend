...
function CategoriesNav({categories}: { categories: string[] }) {
    return (
        <div
            className="flex flex-col gap-4 items-start w-3/4 overflow-y-auto overscroll-none max-h-[calc(100vh-200px)]">
...
function Header({categories, setSearch, saleProductAmount, setIsOpenSales}: IHeaderProps) {
    return (
