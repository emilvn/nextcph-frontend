...
function ProductForm(props: IProductFormProps) {
	...
	return (
		<form onSubmit={handleSubmit(submitForm)} className="flex flex-col gap-2 max-w-[500px] text-next-blue font-semibold">
			<h2 className="text-center text-2xl text-next-blue">{props.title}</h2>
