	...
	return (
		<footer className="fixed bottom-0 left-0 right-0 h-[calc(100vh-80px)] text-next-grey flex items-center justify-evenly mr-20 ml-20 p-4 gap-8" >
			<div className="w-80">
				...
				<p className="text-next-grey">Vi er en gruppe af 4 studerende fra Københavns Erhvervsakademi, der har lavet denne hjemmeside som en del af vores 2. semester projekt.</p>
			</div>
			<div>
