    ...
    return (
        <footer className="fixed bottom-0 left-0 right-0 h-[calc(60vh-80px)] text-next-grey flex justify-evenly mr-20 ml-20 p-4 gap-8 bg-next-white">
            <div className="w-80">
                ...
                <p className="text-next-grey">
                    Vi er en gruppe af 4 studerende fra Københavns
                    Erhvervsakademi, der har lavet denne hjemmeside som en del
                    af vores førsteårs projekt.
                </p>
            </div>
            <div>
                ...
                <a
                    href="mailto:vira0002@stud.kea.dk"
                    className="cursor-pointer"
                >
                    vira0002@stud.kea.dk
                </a>
